                ...
                <div class="sngl-top">
                    ...
                    <div class="col-md-7 single-top-right">
                        <div class="single-para simpleCart_shelfItem">
                            ...
                            <h5 class="item_price"><?=$curr['symbol_left'];?><?=$product->price * $curr['value'];?>
                            <?=$curr['symbol_right'];
                            ?></h5>
                            ...
                            <div class="quantity">
                                <input type="number" size="4" value="1" name="quantity" step="1">
                            </div>
                            <a id="productAdd" data-id = "<?=$product->id; ?>" href="cart/add?id=<?=$product->id; ?>" class="add-cart
                            item_add add-to-cart-link">ADD TO
                                CART</a>
